...
if __name__ == "__main__":
    ...
    parser.add_argument("--rpg_config_file", type=str, default='test/debug.py')
    ...
    opt.RPG_config_file="test/glyph_original_model_step_50.py"
    config=read_config(opt.RPG_config_file)
    ...
    if opt.layer_data is not None:
        ...
        processed_data=load_inference_data_with_glyph(layer_data)
    ...
    if demo:
        ...
        # for cfg in [18]:
            ...
            data_draw_bbox=load_inference_data_with_glyph()
