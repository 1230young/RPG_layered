...
for group in group_index:
    ...
    for index in group["index"]:
        ...
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>SDXL: RPG base ratio=0.1, CFG=7, Sampler=DPM_adaptive</p>
                </div>""")
        folder='yuyang/code/RPG/multi_layers_base_0.1_cfg_7_DPM_adaptive_bbox'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>SDXL: RPG base ratio=0.1, CFG=7, Sampler=DPM_adaptive bbox</p>
                </div>""")
        print('</div>')
        print('<div class="row">')

        folder='yuyang/code/RPG/mulit_layer_glyph_mixed_w1-1_model_albedobaseXL_base_0.0_sampler_adaptive'
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Glyph SDXL: RPG base ratio=0.0, CFG=7, model=albedobaseXL_v20, ckpt=mixed _w1_1</p>
                </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_mixed_w1-1_model_albedobaseXL_base_0.0_sampler_adaptive_bbox'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Glyph SDXL: RPG base ratio=0.0, CFG=7, model=albedobaseXL_v20, ckpt=mixed _w1_1 bbox</p>
                </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_new_model_albedobaseXL_base_0.0'
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Glyph SDXL: RPG base ratio=0.0, CFG=7, model=albedobaseXL_v20, ckpt=new</p>
                </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_new_model_albedobaseXL_base_0.0_bbox'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
        ...
        folder='yuyang/code/RPG/mulit_layer_glyph_sdxl_canva_1m_albedobaseXL_base_0.0'
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Glyph SDXL: RPG base ratio=0.0, CFG=7, model=albedobaseXL_v20, ckpt=1m</p>
                </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_sdxl_canva_1m_albedobaseXL_base_0.0_bbox'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Glyph SDXL: RPG base ratio=0.0, CFG=7, model=albedobaseXL_v20, ckpt=1m bbox</p>
                </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_cascaded_canva_500k_albedobaseXL_base_0.0'
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Glyph SDXL: RPG base ratio=0.0, CFG=7, model=albedobaseXL_v20, ckpt=cascade 500k</p>
                </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_cascaded_canva_500k_albedobaseXL_base_0.0_bbox'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Glyph SDXL: RPG base ratio=0.0, CFG=7, model=albedobaseXL_v20, ckpt=cascade 500k bbox</p>
                </div>""")
        print('</div>')
        print('<div class="row">')
