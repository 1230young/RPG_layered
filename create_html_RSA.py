...
for group in group_index:
    ...
    for index in group["index"]:
        ...
        folder='yuyang/code/RPG/multi_layers_base_0.1_restrict_selfattn'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>RPG base ratio=0.1, add mask to all self attention</p>
                </div>""")
        folder='yuyang/code/RPG/multi_layers_base_0.1_restrict_selfattn_middle_blocks'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>RPG base ratio=0.1, add mask to middle blocks only</p>
                </div>""")
        folder='yuyang/code/RPG/multi_layers_base_0.1_restrict_selfattn_32'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>RPG base ratio=0.1, add mask to latent size 32*32 only</p>
                </div>""")
        folder='yuyang/code/RPG/multi_layers_base_0.1_restrict_selfattn_64'
        img_name = f"/{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>RPG base ratio=0.1, add mask to latent size 64*64 only</p>
                </div>""")
