...
from inference_data import load_inference_data, load_intention_output_data
    ...
    for i in data:
        ...
        print(f"""
                <div class="row">
                    ...
                    Intention: {item['intention']} </p>
                </div>
        """)
        
        if index % 1 == 0:
            print('<div class="row">')
        folder='yuyang/code/RPG/yifan_layerdiff_20240321'
        img_name = f"/whole_img_{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Layer Diffusion pipeline</p>
                </div>""")
        folder='yuyang/code/RPG/yifan_layerdiff_20240321'
        img_name = f"/layout_output_{index}.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>Predicted Layout</p>
                </div>""")
        ...
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>RPG Glyph SDXL pipeline bbox</p>
                </div>""")
