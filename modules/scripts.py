...
def list_scripts(scriptdirname, extension, *, include_extensions=False):
    scripts = {}
...
def load_scripts():
    ...
    # scripts_list = list_scripts("scripts", ".py") + list_scripts("modules/processing_scripts", ".py", include_extensions=True)
    ...
    def register_scripts_from_module(module):
        for script_class in module.__dict__.values():
            ...
            if issubclass(script_class, Script):
                ...
                print('Script',ScriptClassData(script_class, scriptfile.path, scriptfile.basedir, module))
...
class ScriptRunner:
    ...
    def initialize_scripts(self, is_img2img):
        ...
        for script_data in auto_processing_scripts + scripts_data:
            ...
            if visibility == AlwaysVisible:
                ...
                self.scripts.append(script)
                self.selectable_scripts.append(script)
        print('self.selectable',self.selectable_scripts)
    ...
    def run(self, p, *args):
        ...
        script = self.selectable_scripts[0]
