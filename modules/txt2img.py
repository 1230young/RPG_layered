...
def txt2img(id_task: str, prompt: str, negative_prompt: str, prompt_styles, steps: int, sampler_index: int,
    ...
    base_ratio=kwargs['base_ratio']
    use_base=kwargs['use_base']
    ...
    #activate: True a_debug: False rp_selected_tab: Matrix mmode: Columns xmode: Mask pmode: Prompt aratios: 1,1 
    # bratios: 0.5 usebase: True usecom: False usencom: False calcmode: Attention options: [False] lnter: 0 lnur: 0 threshold: 0.4 
    # polymask: None lstop: 0 lstop_hr: 0 flipper: False
    processed = modules.scripts.scripts_txt2img.run(p,*process_args)
    #     processed = None
