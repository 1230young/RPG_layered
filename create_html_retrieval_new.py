...
for group in group_index:
    ...
    for index in group["index"]:
        ...
        print('</div>')
        print('<div class="row">')
        folder='yuyang/code/RPG/mulit_layer_glyph_new_model_albedobaseXL_base_0.0_retrieval_text_prompt1'  
        img_name = f"/{index}_0.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>retrieval text prompt1</p>
                </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_new_model_albedobaseXL_base_0.0_retrieval_text_prompt1' +"_bbox" 
        img_name = f"/{index}_0.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>retrieval text prompt1 bbox</p>
                    </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_new_model_albedobaseXL_base_0.0_retrieval_visual_prompt1'  
        img_name = f"/{index}_0.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>retrieval visual prompt1</p>
                </div>""")
        folder='yuyang/code/RPG/mulit_layer_glyph_new_model_albedobaseXL_base_0.0_retrieval_visual_prompt1' +"_bbox" 
        img_name = f"/{index}_0.png"
        print(f"""
                <div class="column">
                    <img src="{file_prefix + folder + img_name + file_sufix}" alt="image" style="max-width: 100%;">
                    <p>retrieval visual prompt1 bbox</p>
                    </div>""")
        print('</div>')
        print('<div class="row">')
